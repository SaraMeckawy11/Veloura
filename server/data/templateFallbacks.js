const commonPlaceholders = [
  ...
  { key: 'timeFormat', label: 'Time Format', type: 'select', required: false, defaultValue: '12h' },
...
export const fallbackTemplates = [
  ...
  },
  {
    ...
    slug: 'fountain-reverie-v1',
    category: 'launch',
    description: 'A sunlit garden fountain invitation with ornate gold typography and an elegant sage envelope reveal.',
    envelope: 'Sage envelope opens to a sunlit fountain invitation',
    previewImage: '',
    colorScheme: { primary: '#94742f', secondary: '#f5dfcf', background: '#fff6e8' },
    placeholders: commonPlaceholders,
    active: true,
  },
  {
    name: 'Fountain Reverie II',
    slug: 'fountain-reverie-v2',
    category: 'launch',
    description: 'A floral garden fountain invitation framed by pillars, soft gold, and romantic script.',
    envelope: 'Ornate garden doors open to a wide floral fountain invitation',
    previewImage: '',
    colorScheme: { primary: '#94742f', secondary: '#87916c', background: '#fff6e8' },
    placeholders: commonPlaceholders,
    active: true,
  },
  {
