...
export default function OrderFlow() {
  ...
  const localTemplates = [
    ...
    { _id: 'gazebo-garden', name: 'Garden Pavilion', slug: 'gazebo-garden', category: 'launch', envelope: 'Sage envelope opens into a watercolor garden pavilion', colorScheme: { primary: '#86ad61', secondary: '#fff8ea', background: '#eff8dc' } },
    ...
    { _id: 'fountain-reverie-v1', name: 'Fountain Reverie', slug: 'fountain-reverie-v1', category: 'launch', envelope: 'Animated garden envelope opens to a sunlit fountain invitation', colorScheme: { primary: '#94742f', secondary: '#f5dfcf', background: '#fff6e8' } },
