...
const getPreviewStyle = (layout, photoStyle) => ({
...
export default function OrderFlow() {
  ...
  const selectedUploadStyle = TEMPLATE_UPLOAD_STYLES[selectedTemplate?.slug] || TEMPLATE_UPLOAD_STYLES['boarding-pass'];
  const storyPreviewStyle = getPreviewStyle(selectedUploadLayout.story, selectedUploadStyle.story);
  const galleryPreviewStyle = getPreviewStyle(selectedUploadLayout.gallery, selectedUploadStyle.gallery);
