...
export default function OrderFlow() {
  ...
  const localTemplates = [
    ...
    { _id: 'gazebo-garden', name: 'Watercolor Garden Gazebo', slug: 'gazebo-garden', category: 'launch', envelope: 'Animated envelope opens into a watercolor garden gazebo with a bird in flight', colorScheme: { primary: '#86ad61', secondary: '#fff8ea', background: '#eff8dc' } },
