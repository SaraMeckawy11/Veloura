// Shared "A note for our guests" block rendered in the details section of the
// card-based invitation designs. Each design passes its own theme class so the
// surrounding CSS can style the kicker, list, and icons to match the palette.
...
export default function GuestNote({ lines, className = '', label = 'A note for our guests' }) {
