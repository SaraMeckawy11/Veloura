...
export const PRICING_TIERS = [
  {
    ...
    amount: '49.00',
    oldAmount: '69.00',
    description: 'A polished digital invitation with your core wedding details, cinematic reveal, countdown, map link, and a personal note for your guests.',
    features: [
  ...
  },
  {
    ...
    amount: '74.00',
    oldAmount: '99.00',
    description: 'The complete Veloura experience with RSVP replies, live guest tracking, and premium sections that make your invitation feel like a full wedding website.',
    featured: true,
    features: [
